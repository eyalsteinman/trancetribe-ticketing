...
-- Create trigger to call the function when admin offers are inserted
CREATE OR REPLACE TRIGGER trigger_notify_tribe_with_offer
  AFTER INSERT ON public.admin_offers
  FOR EACH ROW
  EXECUTE FUNCTION notify_tribe_with_offer();