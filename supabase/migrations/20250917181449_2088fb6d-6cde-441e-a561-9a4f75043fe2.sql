...
DROP TRIGGER IF EXISTS trigger_friend_addition_notification ON public.friends;
DROP TRIGGER IF EXISTS trigger_friend_acceptance ON public.direct_messages;
