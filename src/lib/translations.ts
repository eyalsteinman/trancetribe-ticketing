export const translations = {
  ...
  he: {
    ...
    // Additional Auth translations
    'user_login_registration': 'התחברות/הרשמת משתמש',
    'dont_have_account': 'אין לך חשבון?',
    'have_account': 'יש לך חשבון?',
    'sign_in_to_account': 'התחבר לחשבון שלך',
    'create_account_description': 'צור את החשבון שלך עם השם המלא שלך וקבל גישה מיידית',
    'admin_access': 'גישת מנהל',
    'admin_credentials_description': 'התחבר עם פרטי הכניסה של המנהל שלך',
    ...
    'google': 'Google',
    'facebook': 'Facebook',
    'google_signin_failed': 'נכשל להתחבר עם Google',
    'facebook_signin_failed': 'נכשל להתחבר עם Facebook',
    'account_created_verify_email': 'החשבון נוצר! אנא בדוק את האימייל שלך כדי לאמת את החשבון שלך.',
