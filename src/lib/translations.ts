export const translations = {
  en: {
    ...
    'join_tribes': 'Join Production Tribes',
    'join_tribe': 'Join Tribe',
    'leave_tribe': 'Leave Tribe',
    'login_to_join_tribe': 'Login to Join this Tribe',
    'games': 'Games',
    ...
    'cant_buy_tickets_without_socials': 'You can\'t buy tickets for parties and events without entering social network profiles.',
    'can_do_later_question': 'This can be done later. Are you sure you wish to continue?',
    'go_back': 'Go Back',
    'continue_anyway': 'Continue Anyway',
    'social_media_required': 'Social Media Required',
    'social_media_required_description': 'Please complete your social media profiles to continue.',
    'missing_social_networks': 'Missing Social Networks',
  ...
  he: {
    ...
    'create_account_description': 'צור חשבון עם פרטים מלאים',
    ...
    'enter_first_name': 'הכנס שם פרטי',
    'enter_last_name': 'הכנס שם משפחה',
    ...
    'can_do_later': 'אפשר לעשות מאוחר יותר',
    'cant_buy_tickets_without_socials': 'לא תוכל לקנות כרטיסים לאירועים ומסיבות ללא הזנת פרופילי רשתות חברתיות.',
    'can_do_later_question': 'ניתן לעשות זאת מאוחר יותר. האם אתה בטוח שברצונך להמשיך?',
    'go_back': 'חזור אחורה',
    'continue_anyway': 'המשך בכל זאת',
    'social_media_required': 'נדרשות רשתות חברתיות',
    'social_media_required_description': 'נא להשלים את פרופילי הרשתות החברתיות שלך כדי להמשיך.',
    'missing_social_networks': 'רשתות חברתיות חסרות',
    'processing': 'מעבד...',
    ...
    'join_tribes': 'הצטרפות לשבטי הפקה',
    'join_tribe': 'הצטרפות לשבט',
    'leave_tribe': 'עזיבת שבט',
    'login_to_join_tribe': 'התחבר כדי להצטרף לשבט זה',
    'games': 'משחקים',
    ...
    // Additional Auth translations - no duplicates
  ...
  sp: {
    ...
    'cant_buy_tickets_without_socials': 'No puedes comprar boletos para eventos y fiestas sin ingresar perfiles de redes sociales.',
    'can_do_later_question': 'Esto se puede hacer más tarde. ¿Estás seguro de que deseas continuar?',
    'go_back': 'Volver',
    'continue_anyway': 'Continuar de Todos Modos',
    'social_media_required': 'Redes Sociales Requeridas',
    'social_media_required_description': 'Por favor completa tus perfiles de redes sociales para continuar.',
    'missing_social_networks': 'Redes Sociales Faltantes',
  ...
  fr: {
    ...
    'cant_buy_tickets_without_socials': 'Vous ne pouvez pas acheter de billets pour les événements et les fêtes sans saisir les profils de réseaux sociaux.',
    'can_do_later_question': 'Cela peut être fait plus tard. Êtes-vous sûr de vouloir continuer?',
    'go_back': 'Retour',
    'continue_anyway': 'Continuer Quand Même',
    'social_media_required': 'Réseaux Sociaux Requis',
    'social_media_required_description': 'Veuillez compléter vos profils de réseaux sociaux pour continuer.',
    'missing_social_networks': 'Réseaux Sociaux Manquants',
  ...
  it: {
    ...
    'cant_buy_tickets_without_socials': 'Non puoi acquistare biglietti per eventi e feste senza inserire i profili dei social network.',
    'can_do_later_question': 'Questo può essere fatto più tardi. Sei sicuro di voler continuare?',
    'go_back': 'Torna Indietro',
    'continue_anyway': 'Continua Comunque',
    'social_media_required': 'Social Media Richiesti',
    'social_media_required_description': 'Completa i tuoi profili social media per continuare.',
    'missing_social_networks': 'Social Network Mancanti',
