  ...
  public: {
    Tables: {
      ...
      loyalty_points: {
        ...
        Relationships: [
          {
            foreignKeyName: "loyalty_points_party_id_fkey"
            columns: ["party_id"]
            isOneToOne: false
            referencedRelation: "parties"
            referencedColumns: ["id"]
      ...
      party_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "party_reviews_party_id_fkey"
            columns: ["party_id"]
            isOneToOne: false
            referencedRelation: "parties"
            referencedColumns: ["id"]
      ...
      party_waitlist: {
        ...
        Relationships: [
          {
            foreignKeyName: "party_waitlist_party_id_fkey"
            columns: ["party_id"]
            isOneToOne: false
            referencedRelation: "parties"
            referencedColumns: ["id"]
      ...
      promo_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "promo_codes_party_id_fkey"
            columns: ["party_id"]
            isOneToOne: false
            referencedRelation: "parties"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "promo_codes_production_id_fkey"
            columns: ["production_id"]
            isOneToOne: false
            referencedRelation: "productions"
            referencedColumns: ["id"]
